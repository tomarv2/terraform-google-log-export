locals {
  ...
  */
  existing_topic_name = var.existing_topic_name != null ? "pubsub.googleapis.com/${var.existing_topic_name}" : "pubsub.googleapis.com/projects/${var.project}/topics/${local.topic_name}"
